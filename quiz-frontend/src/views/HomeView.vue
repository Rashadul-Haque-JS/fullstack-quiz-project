  ...
  <div class="home">
   <header class="main-block" >
    <img
      ...
      <router-link to='/login' v-for="genre in genres" :key="genre">
        <Card :genre="genre"/>
      </router-link>
      </div>

      <div class="genre-image" v-else>
      <router-link to='/quiz' v-for="genre in genres" :key="genre">
        <Card :genre="genre"/>
      </router-link>
      </div>
      </main>
...
<script>
// @ is an alias to /src
import Card from '../components/GenreCard.vue'
